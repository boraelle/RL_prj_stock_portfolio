"""
ETF 데이터 수집 스크립트 (TIGER 중심 버전)
- TIGER: 섹터 ETF (안정적)
- KODEX: 특수산업 ETF (차별화)
- 학습/평가: 2024년 1월 ~ 2025년 11월 (23개월)
"""
...
ASSETS = {
    ...
    'TIGER_200_Telecom': '252700',     # 커뮤니케이션
    'TIGER_200_Utilities': '252690',   # 유틸리티
...
def collect_etf_data(start_date, end_date):
    ...
    print(f"   TIGER 섹터 ETF: 10개")
    print(f"   KODEX 특수산업 ETF: 4개")
    print(f"   현금: 1개 (코드에서 추가) = 총 15자산\n")
...
if __name__ == "__main__":
    print("=" * 70)
    print("🎯 ETF 데이터 수집 (TIGER 중심)")
    print("   기간: 2024년 1월 ~ 2025년 11월 (23개월)")
    print("   구성: TIGER 섹터 10개 + KODEX 특수산업 4개 + 현금 1개")
    print("=" * 70)
    print()
